...
class TestDataProject(unittest.TestCase):
    ...
    def test_number_of_matches_played_per_year(self):
        ...
        lst_of_season, lst_of_matches_played_per_year = dp.num_of_match_each_year(self.sample_match1)
    ...
    def test_stacked_bar_chart(self):
        ...
        dict_of_matches_won_each_season = dict(dp.stacked_bar_chart(self.sample_match1)[0])
    ...
    def test_match_2016_extra_run(self):
        ...
        expected_value1 = {}
        extra_run_per_team = dp.match_2016_extra_run(self.sample_match1, self.sample_delivery1)
    ...
    def test_match_2015_eco_bowler(self):
        ...
        bowler_eco_rate = dict(dp.match_2015_eco_bowler(self.sample_match1, self.sample_delivery1))
    ...
    def test_match_summary_over_years(self):
        ...
        player_of_match = dict(dp.match_summary_over_years(self.sample_match1, season1))
